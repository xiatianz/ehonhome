// 云端同步 UI - Supabase Auth 方案（Email + GitHub + 支付宝登录）
...
function showLoginDialog() {
    ...
    content: `
      <div class="auth-dialog">
        ...
        <div class="auth-form" id="auth-login-form">
          ...
          <button class="auth-alipay-btn" id="auth-alipay-login-btn">
            <svg viewBox="0 0 1024 1024" width="18" height="18" fill="currentColor"><path d="M789.952 319.168c-37.888-14.336-78.336-21.504-120.32-21.504-60.416 0-115.2 16.384-155.136 46.592V140.8H389.12v432.128c0 83.968-68.096 152.064-152.064 152.064S84.992 656.896 84.992 572.928s68.096-152.064 152.064-152.064c22.016 0 42.496 4.608 61.44 12.8V319.168c-19.456-5.632-39.936-8.704-61.44-8.704C65.536 310.464 0 476.16 0 572.928c0 96.768 65.536 262.464 237.056 262.464 96.256 0 176.128-53.248 219.648-132.096 12.8 27.136 29.184 52.224 49.664 73.728 46.592 49.152 108.032 76.288 173.056 76.288 65.024 0 126.464-27.136 173.056-76.288 44.032-46.592 68.096-108.032 68.096-173.056v-10.752c-35.328 22.528-78.336 35.328-123.904 35.328-83.968 0-152.064-68.096-152.064-152.064V319.168h125.44v118.272c0 83.968 68.096 152.064 152.064 152.064 41.472 0 78.848-16.384 106.496-43.52-14.336-37.376-35.84-70.144-63.488-96.768-14.848-14.848-31.232-27.648-48.128-38.912v-91.136z"/></svg>
            使用支付宝登录
          </button>
        ...
        <div class="auth-form" id="auth-register-form" style="display:none">
          ...
          <button class="auth-alipay-btn" id="auth-alipay-reg-btn">
            <svg viewBox="0 0 1024 1024" width="18" height="18" fill="currentColor"><path d="M789.952 319.168c-37.888-14.336-78.336-21.504-120.32-21.504-60.416 0-115.2 16.384-155.136 46.592V140.8H389.12v432.128c0 83.968-68.096 152.064-152.064 152.064S84.992 656.896 84.992 572.928s68.096-152.064 152.064-152.064c22.016 0 42.496 4.608 61.44 12.8V319.168c-19.456-5.632-39.936-8.704-61.44-8.704C65.536 310.464 0 476.16 0 572.928c0 96.768 65.536 262.464 237.056 262.464 96.256 0 176.128-53.248 219.648-132.096 12.8 27.136 29.184 52.224 49.664 73.728 46.592 49.152 108.032 76.288 173.056 76.288 65.024 0 126.464-27.136 173.056-76.288 44.032-46.592 68.096-108.032 68.096-173.056v-10.752c-35.328 22.528-78.336 35.328-123.904 35.328-83.968 0-152.064-68.096-152.064-152.064V319.168h125.44v118.272c0 83.968 68.096 152.064 152.064 152.064 41.472 0 78.848-16.384 106.496-43.52-14.336-37.376-35.84-70.144-63.488-96.768-14.848-14.848-31.232-27.648-48.128-38.912v-91.136z"/></svg>
            使用支付宝登录
          </button>
          <div class="auth-divider"><span>或使用邮箱</span></div>
  ...
  // ── 支付宝登录 ─────────────────────────────────────────
  dd.querySelector('#auth-alipay-login-btn').onclick = () => {
    supabaseAuth.signInWithAlipay();
  };
  dd.querySelector('#auth-alipay-reg-btn').onclick = () => {
    supabaseAuth.signInWithAlipay();
  };
  // ── 登录 ───────────────────────────────────────────────
